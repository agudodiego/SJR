...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Override
    protected void doFilterInternal(HttpServletRequest request, //Solicitud entrante
                                    HttpServletResponse response, //Respuesta saliente
        ...
        if (StringUtils.hasText(token) && jwtGenerador.validarToken(token)) {
            ...
            //Cargamos una lista de String con los roles alojados en el enum
